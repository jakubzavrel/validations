export default {
    ...
    includes(array, values, strict = false) {
        ...
        for (let i = 0; i < valuesCollection.length; i += 1) {
    ...
    /**
     * @method sum
     * @description Counts sum of an array of numbers
     * @param {Array} array
     * @return {Number}
     */
    sum(array) {
    ...
    /**
     * @param  {array} arr        array of aray of any objects/numbers/...
     * @param  {number} fromIndex index of item which will be moved
     * @param  {number} toIndex   index where item will be moved to
